! function (n, e) {
    ...
    var e = Element.prototype,
        ...
        l = function (n, e) {
            ...
            for (var t = o.all(e, n.parentNode), i = 0; i < t.length; ++i)
                if (t[i] == n) return !0;
            return !1
        };
    try {
    ...
    var t = function () {
        ...
        u = "docsify-pagination-container";
    ...
    window.$docsify = window.$docsify || {}, window.$docsify.plugins = [function (n, e) {
        ...
        function i() {
            ...
            n && (n.innerHTML = v(function (n) {
                try {
                    var t = n.route.path,
                        e = f(a.all(".sidebar li a")).filter(function (n) {
                            return !l(n, ".section-link")
                        }).find(g(t)),
                        i = f((c(e, "ul") || {}).children).filter(function (n) {
                    ...
                    return {
                        prev: new m(i[o - 1]).toJSON(),
                        next: new m(i[o + 1]).toJSON()
                    }
                } catch (n) {
                    return {}
                }
