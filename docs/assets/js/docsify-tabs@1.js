...
! function () {
    ...
    ! function (t, a) {
        ...
        if (t && "undefined" != typeof document) {
            ...
            c.type = "text/css", "top" === o && s.firstChild ? s.insertBefore(c, s.firstChild) : s.appendChild(c), c.styleSheet ? c.styleSheet.cssText = t : c.appendChild(document.createTextNode(t))
        }
        ...
        t.beforeEach(function (t) {
            return (o = h.tabBlockMarkup.test(t)) && (t = function (s) {
                for (var t, a, o = s.match(h.codeMarkup) || [], c = o.map(function (t, a) {
                    ...
                    r = (r = r.replace(l, i)).replace(y, n), s = s.replace(t[0], r)
                }
            ...
            var t, a, c;
            o && (t = document.querySelector(".".concat(g.tabsContainer)), a = t ? Array.apply(null, t.querySelectorAll(".".concat(g.tabBlock))) : [], c = JSON.parse(sessionStorage.getItem(window.location.href)) || {}, a.forEach(function (t, a) {
                ...
                ! function a(t, o) {
                    if (t.classList.contains(g.tabButton)) {
                        ...
                        if (i.forEach(function (t) {
                            ...
                            b[d] = c, sessionStorage.setItem(window.location.href, JSON.stringify(b))
                        }
